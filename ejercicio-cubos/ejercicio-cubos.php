...
<body>
    <div class="container">
        ...
        <div id="exercise1-section">
            ...
            <button onclick="nextSection('exercise2-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise2-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise3-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise3-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise4-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise4-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise5-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise5-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise6-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise6-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise7-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise7-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise8-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise8-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise9-section')">Siguiente</button>
        </div>
        ...
        <div id="exercise9-section" style="display:none;">
            ...
            <button onclick="nextSection('exercise10-section')">Siguiente</button>
        </div>
