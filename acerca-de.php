        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <button onclick="window.location.href='contacto.php'"class="btn-contacto">Contacto</button>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-6">
                    <h3>Visión</h3>
                    <p>Ser un referente en la detección temprana de la dislexia, contribuyendo al desarrollo educativo de los niños y a la creación de estrategias efectivas de enseñanza inclusiva.</p>
                </div>
                <div class="col-md-6">
                    <h3>Misión</h3>
